export const captainzAbi = [
    ...
    inputs: [
      {
        components: [
          ...
          {
            internalType: 'uint256[]',
            name: 'potatozTokenIds',
            type: 'uint256[]',
          },
        ],
        internalType: 'struct Captainz.QuestInfo[]',
        name: 'questInfos',
        type: 'tuple[]',
      },
    ],
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'tokenId', type: 'uint256' },
      { internalType: 'uint256[]', name: 'potatozTokenIds', type: 'uint256[]' },
    ],
    name: 'editQuest',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'getTokenInfo',
    outputs: [
      { internalType: 'uint256', name: 'lastQuestedAt', type: 'uint256' },
      { internalType: 'uint256[]', name: 'crewTokenIds', type: 'uint256[]' },
  ...
  },
  {
    inputs: [],
    name: 'mvpContract',
    outputs: [{ internalType: 'contract IMVP', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [],
    name: 'potatozContract',
    outputs: [{ internalType: 'contract IPotatoz', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'potatozTokenId', type: 'uint256' }],
    name: 'removeCrew',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'bool', name: 'b', type: 'bool' }],
    name: 'setCanQuest',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'address', name: 'addr', type: 'address' }],
    name: 'setPotatozContract',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'string', name: '_tokenURIOverride', type: 'string' }],
    name: 'setTokenURIOverride',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'string', name: '_tokenURISuffix', type: 'string' }],
